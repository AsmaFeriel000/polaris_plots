...
"""calculate rmsd between top scoring (gnina score, not affinity property in cs_optimised*.sdf) and their corresponding test_mers.sdf (released test molecules) to generate cdf plot"""
