...
1) To convert a list of smiles to 3d sdf file, run prep3D-sars.ipynb
...
2) Run following commands to use gnina for docking sdf file you just created
	...
	./gnina -r complex-sars.pdb -l lig-3D-H.sdf --autobox_ligand lig-H.sdf --seed 0 --no_gpu -o docked.sdf
