...
"""if N molecules picked at random and RMSD calculated against test_sars.sdf (released test mol) upto 100 times, how many of those will have rmsd <2 A"""

def random_pick_rmsd_analysis(
    fegrow_dir="../../02-building-poses-in-ApoDock-receptors/output/resulting_mols",
    test_sdf="../../../released-receptor-structures/released_test_molecules/test_sars-no-47.sdf", # no-47 means we have removed the outlier present in the data provided by competition organisers
    rmsd_threshold=2.0,
    max_N=20,
    iterations=100
):
    ...
    summary_file = os.path.join("output", "random_pick_rmsd_summary.csv")
    ...
    all_rmsd_file = os.path.join("output", "random_pick_all_rmsds.csv")
...
if __name__ == "__main__":
    random_pick_rmsd_analysis(
        fegrow_dir="../../02-building-poses-in-ApoDock-receptors/output/resulting_mols",
        test_sdf="../../../released-receptor-structures/released_test_molecules/test_sars-no-47.sdf",
        rmsd_threshold=2.0,
        max_N=20,
        iterations=100  
    )
