...
"""Find the best (lowest) RMSDs for each test molecule against corresponding candidate ligands docked by FEgrow to Apodock predcited receptors.
""" 

def find_best_rmsds(test_sdf_path, fegrow_dir, output_csv):
...
if __name__ == "__main__":
    ...
    output_csv = output_dir / "lowest_rmsds.csv"
