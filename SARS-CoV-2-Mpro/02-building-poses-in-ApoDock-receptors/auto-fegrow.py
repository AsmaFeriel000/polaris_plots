...
def main():
    ...
    input_folder = "../01-ApoDock-side-chain-modelling/output/complex-sars-lig-h.sdf/receptors_with_hydrogen"        
    ...
    for pdb_file in pdb_files:    
        ...
        scaffold = Chem.SDMolSupplier('input/sars-lig-H.sdf')[0]

        with open('input/smiles-test-SARS.txt') as f:    
        ...
        cs.df.to_csv(
            os.path.join(OUTPUT_DIR, "SARS-out.csv"),
            index=True
        )
