...
"""for each N top scoring molecules (based on binding affinity property), find percentage of molecules with RMSD <2A
    ...
    for rec_file in rec_files:
        ...
        for mol in supplier:
            ...
            try:
                ...
                print(f" Failed parsing in {rec_file}, error={e}")
                continue
