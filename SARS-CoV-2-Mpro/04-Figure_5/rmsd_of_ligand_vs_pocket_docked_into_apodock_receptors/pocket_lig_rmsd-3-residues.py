...
"""Compute ligand RMSD and pocket RMSD between docked SARS-CoV-2 Mpro complexes (FEgrow to ApoDock receptors)
...
out_csv = output_dir / "complex_rmsd_results-3-residues.csv"
...
# Load CSV
# -------------------------
csv_file = output_dir / "complex_rmsd_results-3-residues.csv"
