...
to be converted to PDB format using Open Babel. The final output will be a set of PDB files, each containing the receptor and one ligand, named "complex-SARS-mol<ID>.pdb".  

"""
# -----------------------------
# INPUT FILES
# -----------------------------
input_pdb = "./input/sars-submission-complex/complex-SARS.pdb"
input_sdf = "./input/submitted_structures/cs_optimised_molecules.sdf"
