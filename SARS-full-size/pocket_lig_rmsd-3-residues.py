...
"""Compute ligand RMSD and pocket RMSD between docked SARS-CoV Mpro complexes (FEgrow to ApoDock receptors)
...
Outputs results to "complex_rmsd_results-3-residues.csv".
"""
...
out_csv = "complex_rmsd_results-3-residues.csv"
# ======================
...
# Load CSV
# -------------------------
csv_file = "complex_rmsd_results-3-residues.csv"
...
plt.savefig("ligand_vs_pocket_rmsd-3-residues_lowest_per_mol.png", dpi=300)
plt.show()
