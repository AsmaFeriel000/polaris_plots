...
reference_dir = Path("released_SARS-CoV-2_Mpro/sars_files")
...
out_csv = "complex_rmsd_results-submitted-vs-ref-3-residues.csv"
# ======================
...
plt.savefig("ligand_vs_pocket_rmsd_submitted_vs_ref-3-residues.png", dpi=300)
plt.show()
