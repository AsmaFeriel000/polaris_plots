...
"""calculate rmsd between top scoring FEgrow-docked ligands (binding affinity scores) and their corresponding test_mers.sdf (released test molecules) to generate cdf plot
"""
