...
The script will skip the ligand with index 78 as per instructions. The output complexes will be saved in the "output" directory.
...
# INPUT FILES
# -----------------------------
input_pdb = "./input/mers-submission-complex/complex-MERS.pdb"
